...
Check out the branch [roa1-hooks](https://github.com/emmericp/dosbox-hooks/tree/roa1-hooks) for an example of hooking a real function in a real game.
The same installation steps from above apply there as well.
